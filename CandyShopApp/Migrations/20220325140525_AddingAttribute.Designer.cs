...
namespace CandyShopApp.Migrations
{
    ...
    [Migration("20220325140525_AddingAttribute")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandyShopApp.Models.Candy", b =>
                {
            ...
            modelBuilder.Entity("CandyShopApp.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CandyShopApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("CandyShopApp.Models.OrderOp.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("CandyShopApp.Models.ShoppingCartOp.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CandyShopApp.Models.Candy", b =>
                {
                    b.HasOne("CandyShopApp.Models.Category", "Category")
                        .WithMany("Candies")
            ...
            modelBuilder.Entity("CandyShopApp.Models.OrderOp.OrderDetail", b =>
                {
                    b.HasOne("CandyShopApp.Models.Candy", "Candy")
                        .WithMany()
                        .HasForeignKey("CandyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CandyShopApp.Models.Order", "Order")
